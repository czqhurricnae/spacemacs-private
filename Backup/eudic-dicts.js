function mainJob(url, meaning="", notes="", pronunciation="") {
...
if (url.match(/http[s]?:\/\/*dict.eudic.net\/dicts\/en\/*/)) {
    ...
    $("a.voice-button").each(function() {
        const audioUrl =
            ...
            $(this).attr("data-rel");
        insertDownloadLink(audioUrl, $(this), true, meaning, notes, pronunciation);
    });
}}
...
;
    const meaning = ExpFCChild + ExpSYNChild;
    ...
    $("a#ui-id-6").bind("click", function() { setTimeout(function() { mainJob(document.URL, meaning, notes, pronunciation); }, "2000"); });
})
