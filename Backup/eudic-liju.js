...
function insertDownloadLink(
    ...
    ELEMENT.bind("click", function() {
        const { word, mp3, dataRel, line, exp } = prepareContent($(this)[0]);
        // const params = {
        //     "action": "addNote",
        //     "version": 6,
        //     "params": {
...
function prepareContent(node) {
    ...
    let mp3 = formatMp3Name(new Date(), word);
    return({ word, mp3, dataRel, line, exp });
}
...
function formatMp3Name(date, word) {
    ...
    var strTime = 'eudic_' + hours + '_' + minutes + '_' + seconds + '_' + ampm + '_' + word + '.mp3';
    return strTime;
}
