...
(custom-set-faces
 ...
 '(helm-selection-line ((t (:inherit isearch))))
 ...
 '(mode-line ((t (:foreground "#e9e2cb" :background "#2075c7" :distant-foreground "#e9e2cb" :foreground "#e9e2cb" :inverse-video nil))))
 '(mode-line-inactive ((t (:foreground "#2075c7" :background "#e9e2cb" :inverse-video nil))))
 '(org-format-latex-options ((t (:foreground default :background default :scale 3.0 :html-foreground "Black" :html-background "Transparent" :html-scale 1.0 :matchers ("begin" "$1" "$" "$$" "\\(" "\\[")))))
