    ...
    (progn
      ...
      (cond ((equal src-code-type "ipython")
            ...
            ((equal src-code-type "example")
             (insert (format "#+BEGIN_SRC %s :preamble # -*- coding: utf-8 -*- :results raw drawer output list :exports both :session example\n" src-code-type)))
            ((equal src-code-type "value")
             (insert (format "#+BEGIN_SRC %s :preamble # -*- coding: utf-8 -*- :results raw drawer output value :exports both :session \n" src-code-type))) 
