...
(defun blog-site-project-setup ()
  ...
  (set (make-local-variable 'org-publish-project-alist)
       (backquote (("orgfiles"
                    ...
                    :base-directory ,default-directory  ;; local dir
                    :publishing-directory ,(concat deft-dir "public/" (file-name-nondirectory (directory-file-name (file-name-directory buffer-file-name))) "/")
                    ...
                    :with-author "Hurricane Chen" ;; org-export-with-author
